...
export interface ButtonSelectDropdownDataType {
  id: number;
  value: string;
  appendText?: string;
  inactive?: boolean;
...
export default function ButtonSelectDropdown({
  buttonContent,
    ...
    <>
      ...
      >
        <Popper
          ...
          open={open}
          anchorEl={anchorEl}
          className="z-[100] px-16"
        >
          <div className="mt-1 mr-7 flex w-[335px] flex-col items-start justify-start rounded-lg border border-gray-200 bg-white">
                ...
                {data.map((d, index) => (
                  <div
                    ...
                    className={classNames(
                      d.showBottomDivider
                        ? 'border-b border-gray-200 hover:border-b w-full hover:border-gray-200'
