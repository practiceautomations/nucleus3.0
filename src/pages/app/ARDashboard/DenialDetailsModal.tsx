...
interface DenialDetailModalProp {
  selectedValue?: any;
  onClose: () => void;
}
export default function DenialDetailModal({
  // selectedValue,
  onClose,
}: DenialDetailModalProp) {
  ...
  const [denialStatsDateDropdownData, setDenialStatsDateDropdownData] =
    useState<ChevronDropdownType[]>([]);
  const [deniedClaimsData, setDeniedClaimsData] = useState<
    {
      id: number;
      claim_id: number;
      charge_id: number;
  ...
  >([]);
  const [
    selectedDenialStatsDateDropdownData,
    setSelectedDenialStatsDateDropdownData,
  ] = useState<ChevronDropdownType>();
  useEffect(() => {
    setDeniedClaimsData([
      {
    ...
    setDenialStatsDateDropdownData([
      { id: 1, value: 'Today' },
    ...
    setSelectedDenialStatsDateDropdownData({ id: 1, value: 'Today' });
  }, []);
    ...
    <>
      ...
      >
        ...
        <div className="flex w-[100%] flex-col gap-4 rounded-lg border border-gray-300 bg-white p-4 text-gray-700 shadow ">
          ...
          <div className="flex gap-2">
            <DashboardTiles
              tileTitle={'Top Denial Group + Reason Code'}
              tilesColor={'gray'}
              isShowViewButton={false}
              count="CO-45"
            />
            <DashboardTiles
              tileTitle={'Top Denial Remark Code'}
              tilesColor={'gray'}
              isShowViewButton={false}
              count="N11"
            />
        ...
        <div className="flex w-[100%] flex-col gap-4 rounded-lg border border-gray-300 bg-white p-4 text-gray-700 shadow ">
          <div className="flex gap-2">
            ...
            <ChevronDropdown
              data={denialStatsDateDropdownData}
              selectedValue={selectedDenialStatsDateDropdownData}
              onSelect={(value) => {
                setSelectedDenialStatsDateDropdownData(value);
                if (value.id === 6) {
                  // setcollectedDenialStatsDateModalOpen(true);
          ...
          <div className="flex gap-2">
            <DashboardTiles
              tileTitle={'Avg. Denials per Day in time period'}
              tilesColor={'gray'}
              isShowViewButton={false}
            />
            <DashboardTiles
          ...
          <div className="flex gap-2">
            <DashboardTiles
              tileTitle={'Top Denial Group + Reason Code in time period'}
              tilesColor={'gray'}
              isShowViewButton={false}
              count="CO-45"
            />
            <DashboardTiles
              tileTitle={'Top Denial Remark Code in time period'}
              tilesColor={'gray'}
              isShowViewButton={false}
              count="N11"
            />
